...
public class WSRRUtilityPerformance {
	...
	public static void main(String[] args) throws Exception {
		...
		WSRRUtilityPerformance wut = new WSRRUtilityPerformance();
	...
	public String getGenericObjectByNameAndVersionAndPrimaryTypeExtended(String name, String version,
			String primaryType, String baseURL, String user, String password,String log) {
        //query12
		// Create the variable to return
		String bsrURI = null;
		...
		try {
			...
			urlConnection.setRequestProperty("Content-Type", "text/xml; charset=UTF-8");
			urlConnection.setUseCaches(false);
			urlConnection.setRequestProperty("Trace Header", log);
	...
	public String getSLAassociatedToSLDExtended(String consumerName, String consumerVersion, String bsrURISLDProvider,
			String baseURL, String user, String password,Logger log,String logging) {
        //query 6
		Long tii = System.nanoTime();
		// Create the variable to return
		String bsrURI = null;
		String result = null;
		...
		try {
			...
			urlConnection.setRequestProperty("Content-Type", "text/xml; charset=UTF-8");
			urlConnection.setUseCaches(false);
			urlConnection.setRequestProperty("Trace Header", logging);
		...
		if (bsrURI != null && !bsrURI.contains(">>**ERROR**>>")) {
			if (bsrURI != null && bsrURI.equals("[]")) {
				Long tff = System.nanoTime();
				WSRRUtilityPerformance.logDuration(log," QUERY 6 ", tii, tff);//030218
				result = null;
			}
			else {
				JSONArray jsa = new JSONArray(bsrURI);
				...
				while (i > j) {
					...
					try {
						...
						if (bsrURI != null && !bsrURI.contains(">>**ERROR**>>")) {
							...
							bsrURISLD = WSRRUtilityPerformance.getObjectValueFromJSONArrayData((JSONArray) jsae1.get(0), "bsrURI");

							if (bsrURISLD != null && bsrURISLD.equals(bsrURISLDProvider)) {
								result = bsrURICurrent;
								
								Long tf = System.nanoTime();
								WSRRUtilityPerformance.logDuration(log," QUERY 6 ", ti, tf);//030218
		...
		//Long tf = System.nanoTime();		
		//WSRRUtilityPerformance.logDuration(log," QUERY 6 Tot ", ti, tf);//030218
	...
	public String getSLAassociatedToSLDExtended2(String slaName, String bsrURISLDProvider, String baseURL, String user,
		...
		while (i > j) {
			...
			jsae = (JSONArray) jsa.getJSONArray(j);
			sldURI = WSRRUtilityPerformance.getObjectValueFromJSONArrayData((JSONArray) jsae.get(0), "bsrURI");
	...
	public String getSLAassociatedToSLDWithPrimaryTypeExtended(String consumerName, String consumerVersion,
			String primaryType, String bsrURISLDProvider, String baseURL, String user, String password,Logger log,String logging) {
		...
		while (i > j) {
			...
			try {
				...
				if (bsrURISLD != null && bsrURISLD.equals(bsrURISLDProvider)) {
					...
					Long tf = System.nanoTime();
					WSRRUtilityPerformance.logDuration(log," QUERY 11 ", ti, tf);//030218
		...
		if (result != null && !result.contains(">>**ERROR**>>")) {
			if (result != null && result.equals("[]")) {
				Long tff = System.nanoTime();
				WSRRUtilityPerformance.logDuration(log," QUERY 11 ", tii, tff);//030218
				result = null;
			}
		} else {
			Long tff = System.nanoTime();
	...
	public boolean checkSSAAndAcronimoRelationShip(String acronimo, String bsrURIAcronimo, String bsrURISSA,
			String baseURL, String user, String password,String log,String log1) {
		...
		if (i != 0) {
			...
			result = updateRelationShip(bsrURISSA, "ale63_childOrganizations", bsrURIAcronimo, baseURL, user, password,log1);
	...
	public String getProducerFromEndpointByUriNoSecurity(String endpointURI, String baseURL, String user,
		...
		try {
			...
			e.printStackTrace();
			result = "[" + WSRRUtilityPerformance.jsonWithError(e.getMessage()) + "]";
	...
	public String getServiceVersionTipologyByNameAndVersion(String name, String version, String baseURL, String user,
		...
		if (bsrURI != null) {
			...
			bsrURI = WSRRUtilityPerformance.getValueFromJsonObject(jso, "value");

			classificationRecord = this.getClassificationRecord(bsrURI, baseURL, user, password,log);

			if (classificationRecord != null && classificationRecord.length() != 0) {

				tipology = WSRRUtilityPerformance.getObjectValueFromJSONArrayClassification(classificationRecord, "uri",
	...
	public String getServiceVersionTipologyBybsrURI(String bsrURI, String baseURL, String user, String password,String log) {
	...
	public String getServiceVersionSubTipologyBybsrURI(String bsrURI, String baseURL, String user, String password,String log) {
		...
		if (bsrURI != null) {
			...
			if (classificationRecord != null && classificationRecord.length() != 0) {
				...
				subtipology = WSRRUtilityPerformance.getObjectValueFromJSONArrayClassification(classificationRecord, "uri",
	...
	public String getOrganizationFromGenericObjectByNameAndVersionExtended(String name, String version, String baseURL,
			String user, String password,String log) {
        //query 10
		// Create the variable to return
		String orgName = null;
	...
	public String getEndpointInfo(String name, String version, String interfaceType, String environment,
			String specializzazione, String baseURL, String user, String password,String log) {
		...
		if (data != null && data.equals("[]"))
			...
			while (i > j) {
				jsae = (JSONArray) jsa.getJSONArray(j);
				specializzazione_ = WSRRUtilityPerformance.getObjectValueFromJSONArrayData(jsae, "sm63_SPECIALIZZAZIONE");
	...
	public String getManualMQEndpointInfo(String bsrURI, String baseURL, String user, String password,String log) {
	...
	public String getProxyEndpointNameFromEndpointFilteredByInterface(String bsrURI, String interfaceType,
		...
		if (data != null && !data.equals("[]")) { // fix del 24032017 aggiunto
			...
			data = WSRRUtilityPerformance.getValueFromJsonObject(jso, "value");
		} else
			data = "[]";
	...
	public String createWSRRGenericObject(String xmlData, String verb, String createURL, String user, String password,String log) {
		...
		if (bsrURI != null)
			bsrURI = WSRRUtilityPerformance.getbsrURI(bsrURI);
	...
	public boolean updateSinglePropertyJSONFormat(String bsrURIToChange, String propertyName, String propertyValue,
			String createURL, String user, String password,String log) {
	...
	private static String getObjectValueFromJSONArrayClassification(JSONArray jsa, String key, String field) {
		...
		while (i < elements) {
			...
			if (current.startsWith(field)) {
				...
				result = WSRRUtilityPerformance.getData(current);
	...
	private static void logDuration(Logger log,String target,double ti,double tf) {
		log.info("-------Performance Data---->["+target+"] duration (ms) " + (tf-ti)/1e6);
	}
